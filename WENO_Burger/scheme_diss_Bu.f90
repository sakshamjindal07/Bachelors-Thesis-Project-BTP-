...
do i=3,n-1
	beta(0) = (13.0d0/12.0d0)*(f_plus(i) - 2*f_plus(i+1) + f_plus(i+2))**2 + (1/4.0d0)*(3*f_plus(i)-4*f_plus(i+1)+f_plus(i+2))**2
	beta(1) = (13.0d0/12.0d0)*(f_plus(i-1) - 2*f_plus(i) + f_plus(i+1))**2 + (1/4.0d0)*(f_plus(i-1) - f_plus(i+1))**2
	beta(2) = (13.0d0/12.0d0)*(f_plus(i-2) - 2*f_plus(i-1) + f_plus(i))**2 + (1/4.0d0)*(f_plus(i-2) - 4*f_plus(i-1) + 3*f_plus(i))**2
...
do i=2,2
	beta(0) = (13.0d0/12.0d0)*(f_plus(i) - 2*f_plus(i+1) + f_plus(i+2))**2 + (1/4.0d0)*(3*f_plus(i)-4*f_plus(i+1)+f_plus(i+2))**2
	beta(1) = (13.0d0/12.0d0)*(f_plus(1) - 2*f_plus(i) + f_plus(i+1))**2 + (1/4.0d0)*(f_plus(1) - f_plus(i+1))**2
	beta(2) = (13.0d0/12.0d0)*(f_plus(2) - 2*f_plus(1) + f_plus(i))**2 + (1/4.0d0)*(f_plus(2) - 4*f_plus(1) + 3*f_plus(i))**2
...
do i=1,1
	...
	beta(2) = (13.0d0/12.0d0)*(f_plus(3) - 2*f_plus(2) + f_plus(i))**2 + (1/4.0d0)*(f_plus(3) - 4*f_plus(2) + 3*f_plus(i))**2
...
do i=n+1,n+1
	beta(0) = (13.0d0/12.0d0)*(f_plus(i) - 2*f_plus(n) + f_plus(n-1))**2 + (1/4.0d0)*(3*f_plus(i)-4*f_plus(n)+f_plus(n-1))**2
...
do i=n,n
	beta(0) = (13.0d0/12.0d0)*(f_plus(i) - 2*f_plus(i+1) + f_plus(n))**2 + (1/4.0d0)*(3*f_plus(i)-4*f_plus(i+1)+f_plus(n))**2
	beta(1) = (13.0d0/12.0d0)*(f_plus(i-1) - 2*f_plus(i) + f_plus(i+1))**2 + (1/4.0d0)*(f_plus(i-1) - f_plus(i+1))**2
	beta(2) = (13.0d0/12.0d0)*(f_plus(i-2) - 2*f_plus(i-1) + f_plus(i))**2 + (1/4.0d0)*(f_plus(i-2) - 4*f_plus(i-1) + 3*f_plus(i))**2
...
do i=1,1
	...
	beta(0) = beta(0) + (1/4.0d0)*( 3*f_minus(i+1)- 4*f_minus(i+2)+f_minus(i+3))**2
	beta(1) = (13.0d0/12.0d0)*(f_minus(i) - 2*f_minus(i+1) + f_minus(i+2))**2 + (1/4.0d0)*(f_minus(i) - f_minus(i+2))**2
	beta(2) = (13.0d0/12.0d0)*(f_minus(2) - 2*f_minus(i) + f_minus(i+1))**2 
	beta(2) = beta(2) + (1/4.0d0)*(f_minus(2) - 4*f_minus(i) + 3*f_minus(i+1))**2
...
do i=n+1,n+1
	beta(0) = (13.0d0/12.0d0)*(f_minus(n) - 2*f_minus(n-1) + f_minus(n-2))**2 + (1/4.0d0)*(3*f_minus(n)-4*f_minus(n-1)+f_minus(n-2))**2
	beta(1) = (13.0d0/12.0d0)*(f_minus(i) - 2*f_minus(n-1) + f_minus(n-2))**2 + (1/4.0d0)*(f_minus(i) - f_minus(n-1))**2
	beta(2) = (13.0d0/12.0d0)*(f_minus(i-1) - 2*f_minus(i) + f_minus(n))**2 + (1/4.0d0)*(f_minus(i-1) - 4*f_minus(i) + 3*f_minus(n))**2
...
do i=n,n
	beta(0) = (13.0d0/12.0d0)*(f_minus(i+1) - 2*f_minus(n) + f_minus(n-1))**2 
	beta(0) = beta(0) + (1/4.0d0)*(3*f_minus(i+1)-4*f_minus(n)+f_minus(n-1))**2
	beta(1) = (13.0d0/12.0d0)*(f_minus(i) - 2*f_minus(i+1) + f_minus(n))**2 + (1/4.0d0)*(f_minus(i) - f_minus(n))**2
	beta(2) = (13.0d0/12.0d0)*(f_minus(i-1) - 2*f_minus(i) + f_minus(i+1))**2 
	beta(2) = beta(2) + (1/4.0d0)*(f_minus(i-1) - 4*f_minus(i) + 3*f_minus(i+1))**2
...
do i=n-1,n-1
	beta(0) = (13.0d0/12.0d0)*(f_minus(i+1) - 2*f_minus(i+2) + f_minus(n-1))**2 
	beta(0) = beta(0) + (1/4.0d0)*(3*f_minus(i+1)-4*f_minus(i+2)+f_minus(n-1))**2
	beta(1) = (13.0d0/12.0d0)*(f_minus(i) - 2*f_minus(i+1) + f_minus(i+2))**2 + (1/4.0d0)*(f_minus(i) - f_minus(i+2))**2
	beta(2) = (13.0d0/12.0d0)*(f_minus(i-1) - 2*f_minus(i) + f_minus(i+1))**2 
	beta(2) = beta(2) + (1/4.0d0)*(f_minus(i-1) - 4*f_minus(i) + 3*f_minus(i+1))**2
